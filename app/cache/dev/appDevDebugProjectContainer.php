...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '10.254.94.2', 'port' => 3306, 'dbname' => 's177015', 'user' => 's177015', 'password' => 'duYYF2FY', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/AAKR/StoreBundle/Resources/config/doctrine') => 'AAKR\\StoreBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'AAKR\\StoreBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('AAKRStoreBundle' => 'AAKR\\StoreBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a0b79ae2371605b06c8cc3ed40873c89aec4d9b0d97f069bfd8c35961d25fc27');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/AAKR/StoreBundle/Resources/views'), 'AAKRStore');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AAKRStoreBundle' => 'AAKR\\StoreBundle\\AAKRStoreBundle',
            ...
            'database_port' => 3306,
            'database_name' => 's177015',
            'database_user' => 's177015',
            'database_password' => 'duYYF2FY',
            'mailer_transport' => 'smtp',
            'mailer_host' => '10.254.94.2',
            'mailer_user' => NULL,
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => '10.254.94.2',
